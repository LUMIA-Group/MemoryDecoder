...
class MemoryDecoder(PreTrainedModel, GenerationMixin):
    ...
    #     **kwargs,
    # ):
    #     # GenerationMixin calls this every step when _its_ helpers are used.
    #     # We don’t use the built‑ins, but defining it keeps tooling happy.
    #     return {
    #         "input_ids": input_ids,
    #         "past_key_values": past_key_values,
    #         "knn_past_key_values": knn_past_key_values,
    #     }
